# scripts/opcodes/PRINCEv2/prince_v2_optimized.js

Source: https://github.com/BitVM/bitvm-js/blob/b931a6711ab332fd5923e708c869bed02e39984e/scripts/opcodes/PRINCEv2/prince_v2_optimized.js
...
const prince_MHatMultiply = (base, useMHat0, scratch = 0, sbox = false, sbox_inv = false, middle = false) => {
...
const prince_m_layer = (sbox, sbox_inv, middle) => [
    stats('prince_m_layer'),
    prince_MHatMultiply(0, true, 0, sbox, sbox_inv, middle),      // rows 0‑3
    prince_MHatMultiply(4, false, 0, sbox, sbox_inv, middle),     // rows 4‑7
    prince_MHatMultiply(8, false, 0, sbox, sbox_inv, middle),     // rows 8‑11
    prince_MHatMultiply(12, true, 0, sbox, sbox_inv, middle),     // rows 12‑15
];
...
const middle = _ => [
    ...
    // ]),
    // MC
    prince_m_layer(false, false, true),
    // ⊕ (k1 ⊕ RC11)
    // iter_states(i => [
    //     op_move_state_to_top(i),
